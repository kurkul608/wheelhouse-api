...
Обрати вниманеи, что в model должна обязательно пристуствовать марка авто, а в specification его модель, например для audi rs6 perfomance нужно чтобы в модель попало audi, а в спецификацию rs6 perfomance 
