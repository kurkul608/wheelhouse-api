...
Нужно писать текст с учектом того, что он будет читаться на мобильном устройстве. Нужно делать переносы строки, чтобы это было читаемо с телефона пользователем
`;
